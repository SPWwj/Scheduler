...
using Scheduler.Client.FlappyBird.Helpers;
...
namespace Scheduler.Client.FlappyBird.Data
{
    public class Bird: Printable
    {
        ...
        {
            Universe = universe;
            randPlayer = random.Next(0, Universe.PLAYERS_LIST.Length - 1);
            IsDead=true;
            InitializePlayer();
        ...
        public int GraceInterval => 2000 / Universe.FPSDELAY;
        public int CurrentGraceInterval = 0;

        public int PenaltyTime => 1500 / Universe.FPSDELAY;
        ...
        public Queue<KeyboardEventArgs> KeyPressed = new();
        public bool IsDead;
        ...
        private static bool InRectangle(int pX, int pY, double lX, double uY, double rX, double lY)
        {
            bool isAtLeft = pX < lX;
